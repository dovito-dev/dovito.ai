        ...
        {showToc && (
          ...
          >
            <div className="bg-white/90 backdrop-blur-sm rounded-none border border-gray-200/50 shadow-lg overflow-hidden transition-all duration-300 ease-out w-6 group-hover:w-auto">
              {/* Collapsed indicator bar with vertical label */}
              <div className="absolute left-0 top-0 bottom-0 w-6 bg-[#1a365d] group-hover:opacity-0 transition-opacity duration-300 flex items-center justify-center">
                <span className="text-white/80 text-[10px] font-medium tracking-wider uppercase" style={{ writingMode: 'vertical-rl', transform: 'rotate(180deg)' }}>Contents</span>
              </div>
              {/* Expanded content */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            >
              <a
                href="#contact"
                className="inline-flex items-center gap-2 bg-[#1a365d] text-white px-8 py-4 text-lg font-semibold hover:bg-[#4682b4] transition-colors rounded-none"
